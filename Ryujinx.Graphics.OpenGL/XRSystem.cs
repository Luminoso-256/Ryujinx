...
namespace Ryujinx.Graphics.OpenGL
{
    ...
    {
        // Variables
        private readonly XRGame _game; // keep a reference to our game, it probably has some APIs we want.
        ...
        internal unsafe XRSystem(XRGame game, ulong id)
        {
            _game = game;
            _xr = game.Xr;
            Id = id;

            XRGame.CheckResult(_xr.GetSystemProperties(_game.Instance, Id, ref _props));
